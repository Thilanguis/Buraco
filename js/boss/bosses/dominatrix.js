...
export const dominatrixDefinition = Object.freeze({
  ...
  abilities: Object.freeze([
    ...
    ability('forced_choice', 'Escolha Forçada', 4, [1, 2], () => 'O jogador marcado escolherá entre comprar 2 cartas ou receber 1 Corrente.'),
    ability('exposure', 'Exposição', 3, [1, 2], () => 'Uma carta deverá ser usada antes do fim do turno ou causará 1 Corrente.'),
    ability('forced_swap', 'Troca Forçada', 4, [2, 3], () => 'Uma carta será trocada entre as mãos dos cooperadores.'),
    ability('hands_tied', 'Mãos Atadas', 4, [2, 3], () => 'Cada jogador poderá criar apenas 1 novo jogo nesta rodada.'),
    ability('possession', 'Posse', 3, [2, 3], () => 'Um jogo será possuído e não causará dano até receber 2 cartas.'),
    ability('favorite', 'Favorita', 3, [2, 3], () => 'Uma favorita será protegida e o outro jogador receberá 1 Corrente.'),
    ...
    ability('break_will', 'Quebra de Vontade', 3, [3], () => 'Um jogador com 2 Correntes enfrentará uma escolha pessoal.'),
