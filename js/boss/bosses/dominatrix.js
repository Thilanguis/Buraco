...
export const dominatrixDefinition = Object.freeze({
  ...
  abilities: Object.freeze([
    ...
    ability('forced_choice', 'Escolha Forçada', 4, [1, 2], () => 'O jogador marcado escolherá entre receber 1 Corrente ou aceitar uma ordem válida para o próximo turno.'),
    ...
    ability('interdict', 'Interdito', 4, [2, 3], () => 'A primeira evolução do jogo marcado exigirá obediência ou 1 Corrente.'),
